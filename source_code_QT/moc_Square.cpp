...
static const char qt_meta_stringdata_Square[] = {
    "Square\0"
};
...
const QMetaObjectExtraData Square::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Square::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_Square,
      qt_meta_data_Square, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Square::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Square))
