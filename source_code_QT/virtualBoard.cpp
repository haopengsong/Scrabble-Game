...
bool virtualBoard::boardobserver(vector<Square*> tocompare)
{
   ...
   //if there is a matching location between tiles on the board and candidate tiles, return ture
...
//function to find out the coordinates of the blank tiles,
//mark the square for future use
